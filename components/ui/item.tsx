...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
  return <div role="list" data-slot="item-group" class={cn("group/item-group flex flex-col", className)} {...props} />
}

function ItemSeparator({ className, ...props }: React.ComponentProps<typeof Separator>) {
  return <Separator data-slot="item-separator" orientation="horizontal" class={cn("my-0", className)} {...props} />
}
...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      class={cn("flex w-fit items-center gap-2 font-medium text-sm leading-snug", className)}
      {...props}
    />
  )
}
...
function ItemActions({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="item-actions" class={cn("flex items-center gap-2", className)} {...props} />
}
