...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent class={cn("overflow-hidden p-0", className)} showCloseButton={showCloseButton}>
...
function CommandEmpty({ ...props }: React.ComponentProps<typeof CommandPrimitive.Empty>) {
  return <CommandPrimitive.Empty data-slot="command-empty" class="py-6 text-center text-sm" {...props} />
}
...
function CommandShortcut({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      class={cn("ml-auto text-muted-foreground text-xs tracking-widest", className)}
      {...props}
    />
  )
}
