...
>(({ className, variant, ...props }, ref) => {
  return <ToastPrimitives.Root ref={ref} class={cn(toastVariants({ variant }), className)} {...props} />
})
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} class={cn("font-semibold text-sm", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} class={cn("text-sm opacity-90", className)} {...props} />
))
